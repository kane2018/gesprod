...
class User extends Admin_Controller {
    ...
    public function login() {
        ...
        $this->ion_auth->logged_in() === FALSE || redirect('user/index');
...
//            }
    ...
    public function edit_user($id) {
        ...
        $this->render('auth' . DIRECTORY_SEPARATOR . 'edit_user');
    }
    ...
    public function edit_group($id) {
        ...
        $this->render('auth' . DIRECTORY_SEPARATOR . 'edit_group');
    }
    ...
    public function accueil() {
        if (!$this->ion_auth->logged_in()) {
            ...
            $this->render('auth' . DIRECTORY_SEPARATOR . 'accueil');
        }
    }

    public function logout() {
        $this->data['page_title'] = "Déconnexion";
