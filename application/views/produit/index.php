...
<div class="content-wrapper">
                            ...
                            foreach ($produits as $produit): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php echo $produit->enStock == 1 ? anchor("produit/addquantite/" . $produit->idProd, '<span class="glyphicon glyphicon-plus"></span>', 'class="btn btn-primary"') : ''; ?>
                                        <?php endif; ?>
                                    </td>
    ...
    <?php if ($produit->enStock == 0): ?>
        ...
        <?php endforeach; ?>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Fermer</button>
                                                            <a href="<?php echo site_url('produit/addunite/' . $produit->idProd); ?>" class="btn btn-outline"><span class="fa fa-plus-square"></span></a>
                                                        </div>
                                                    </div>
                                                    <!-- /.modal-content -->
                                                </div>
    ...
    <?php endif; ?>
                                    ...
                                    <td>
                                        <?php if($produit->principal == 1): ?>
                                        <?php echo anchor("produit/edit/" . $produit->idProd, '<span class="glyphicon glyphicon-edit"></span>', 'class="btn btn-primary"'); ?>
                                        <?php endif; ?>
                                    </td>
                                </tr>
    <?php $i++;
endforeach; ?>
                ...
                <p><?php echo anchor('produit/create', 'Ajouter un nouveau Produit') ?></p>
