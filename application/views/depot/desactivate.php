    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-offset-2 col-md-8">
                ...
                <h1><?php echo 'Désactiver un dépôt'; ?></h1>
                <p><?php echo sprintf('Êtes-vous certain de vouloir désactiver le dépot : %s', $depot->nomDepot); ?></p>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <?php echo form_open("depot/desactivate/" . $depot->idDepot); ?>
