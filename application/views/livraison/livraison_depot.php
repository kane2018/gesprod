            ...
            <div class="col-md-offset-1 col-md-10">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Livraisons des dépôts</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body table-responsive">
                        <table class="table table-bordered table-condensed">
                            ...
                            <?php $i = 1; foreach ($livraisonDepots as $cc): ?>
                                <tr>
                                    <td><?php echo $cc->idLiv; ?></td>
                                    <td><?php echo $cc->prenomChauf.' '.$cc->nomChauf; ?></td>
                                    <td><?php echo $cc->marque.' - '.$cc->immatricule; ?></td>
                                    <td><?php echo $cc->nomDepot; ?></td>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <?php if($cc->statut == 0): ?>
                                                        <a href="<?php echo site_url('livraison/ajouterFrais/'.$cc->idLiv); ?>" class="btn btn-outline"><span class="fa fa-plus-square"></span></a>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                <!-- /.modal-content -->
                                    ...
                                    <td>
                                        <?php if($cc->statut == 0): ?>
                                        <a class="btn btn-success" href="<?php echo site_url('livraison/validerLivraison/'.$cc->idLiv); ?>"><span class="glyphicon glyphicon-ok-sign"></span></a>
                                        <?php endif; ?>
                                    </td>
                                    
                                    <td><a class="btn btn-info" target="_blank" href="<?php echo site_url('livraison/voirCommandeDepot/'.$cc->idCommande); ?>"><span class="glyphicon glyphicon-eye-close"></span></a></td>
                                    <td><a class="btn btn-primary" target="_blank" onclick="rafraichir()" href="<?php echo ($cc->facture == 0) ? site_url('livraison/imprimerFacture/'.$cc->idLiv) : site_url('livraison/afficher/'.$cc->facture); ?>"><span class="<?php echo ($cc->facture == 0) ? 'glyphicon glyphicon-print' : 'glyphicon glyphicon-eye-open' ?>"></span></a></td>
                                </tr>
                            <?php $i++; endforeach; ?>
