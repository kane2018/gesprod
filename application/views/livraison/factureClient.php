...
$html = 'Client : '.$client->prenom.' '.$client->nom.'<br/>Adresse : '.$client->adresse.'<br/>Téléphone : '.$client->telephone.'<br/>'
        . '__________________________________________Date le : '.$date.'<br/>';
