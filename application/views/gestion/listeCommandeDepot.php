            ...
            <div class="col-md-offset-1 col-md-10">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Commandes des dépôts</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body table-responsive">
                        <table class="table table-bordered table-condensed">
                            ...
                            <?php $i = 1; foreach ($commandeDepots as $cc): ?>
                                <tr>
                                    <td><?php echo $cc->idCommande; ?></td>
                                    <td><?php echo dateFormatTime('d-m-Y H:i:s', $cc->datecreation); ?></td>
                                    <td><?php echo $cc->nomDepot; ?></td>
                                    <td><?php echo $cc->lieu; ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <?php if($cc->statut == 0): ?>
                                        <a class="btn btn-success" href="<?php echo site_url('commande/livrerDepot/'.$cc->idCommande); ?>"><span class="fa fa-paper-plane-o"></span></a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php $i++; endforeach; ?>
