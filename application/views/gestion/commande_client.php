...
<!--                                <td><a href="<?php echo site_url('commande/annulerProduit'); ?>"></a></td>-->
                    ...
                    <div class="box-footer clearfix">
                        ...
                        <a class="btn btn-primary" href="<?php echo site_url('commande/finaliserClient'); ?>">Valider</a>
                        
                        <a class="btn btn-warning pull-right" href="<?php echo site_url('commande/annulerComClient'); ?>">Annuler</a>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="box box-primary">
                                    ...
                                    <!-- /.box-header -->
                                    <!-- form start -->
                                    <?php echo form_open("commande/createComClient"); ?>
                                    <div class="box-body">
                                        
                                        <div class="form-group">
                                            <label for="depot" style="color: #000">Sélectionner le dépôt</label>
...
<script>
    $(document).ready(function () {
        ...
        $("#depot").change(function (e) {
            var id = encodeURIComponent($("#depot").val());
            $('#categorie').empty();
            if (id !== "") {
                $.ajax({
                    url: '<?php echo site_url('commande/getCategories'); ?>',
                    method: 'post',
                    data: {idDepot: id},
                    dataType: 'json',
                    success: function (json) {
                        $('#categorie').append(json);
                    }
                });
            }
        });
