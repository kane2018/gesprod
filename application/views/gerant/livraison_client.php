                            ...
                            <?php $i = 1; foreach ($livraisonClientsAvec as $cc): ?>
                                <tr>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <?php if($cc->statut == 0): ?>
                                                        <a href="<?php echo site_url('gerant/ajouterFraisClient/'.$cc->idLiv); ?>" class="btn btn-outline"><span class="fa fa-plus-square"></span></a>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                <!-- /.modal-content -->
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-success" href="<?php echo site_url('gerant/validerLivraisonClient/'.$cc->idLiv); ?>"><span class="glyphicon glyphicon-ok-sign"></span></a>
                                        <?php endif; ?>
                                        <?php endif; ?>
                                    </td>
                                    
                                    <td><a class="btn btn-info" target="_blank" href="<?php echo site_url('gerant/voirCommandeClient/'.$cc->idCommande); ?>"><span class="glyphicon glyphicon-eye-close"></span></a></td>
                                </tr>
                            <?php $i++; endforeach; ?>
